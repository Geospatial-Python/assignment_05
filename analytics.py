...
def mean_nearest_neighbors_randomPoints():
    p = 99
    n = 100
    list_means = []
    '''
    print("Default p = 99 and n = 100\n")
    input_change = input("Would you like to change the values? y/n")
    if input_change == 'y' or input_change == 'Y':
    ...
    for i in range(p):
        ...
        newMean = average_nearest_neighbor_distance(randPoints)
